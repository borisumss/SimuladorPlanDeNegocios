    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        guardarDatosPersonaCredito.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vista) {
                ...
                EditText extensionInput = (EditText) getActivity().findViewById(R.id.extDeudorInput);
                EditText telefonoInput = (EditText) getActivity().findViewById(R.id.tefDeudorInput);
                EditText edadInput = (EditText) getActivity().findViewById(R.id.edadDeudorInput);

                Spinner actividadInput = (Spinner) getActivity().findViewById(R.id.actividadInput);
                EditText montoSolicitadoInput = (EditText) getActivity().findViewById(R.id.montoInput);
                Spinner formaPagoInput = (Spinner) getActivity().findViewById(R.id.formaPagoInput);
                EditText plazoInput = (EditText) getActivity().findViewById(R.id.plazoInput);
                TextView cuotaResultado = (TextView) getActivity().findViewById(R.id.cuotaInput);
                TextView interesResultado = (TextView) getActivity().findViewById(R.id.interesInput);


                String nombreDeudor = nombreInput.getText().toString();
                String apellidoDeudor = apellidoInput.getText().toString();
                String estadoCivilDeudor = estadoCivilInput.getSelectedItem().toString();
                String CIDeudor = CIInput.getText().toString();
                String extensionCIDeudor = extensionInput.getText().toString();
                String telefonoDeudor = telefonoInput.getText().toString();
                String edadDedudor = edadInput.getText().toString();

                String actividadCredito = actividadInput.getSelectedItem().toString();
                System.out.println(actividadCredito);
                float montoSolicitadoCredito = Float.parseFloat(montoSolicitadoInput.getText().toString());
                System.out.println(montoSolicitadoCredito);
                String formaPagoCredito = formaPagoInput.getSelectedItem().toString();
                System.out.println(formaPagoCredito);
                int plazoCredito = Integer.parseInt(plazoInput.getText().toString());
